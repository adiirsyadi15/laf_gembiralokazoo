     ...
     <hr>
        <div class="formsetting">
           <div class="col-md-6">
            <h4>identitas 1</h4>
            <hr>
             {!! Form::open(['route' => ['pemilik.identitas.simpan', $pemiliks->username], 'enctype'=>'multipart/form-data', 'id'=>'identitas']) !!}
            <div class="form-group  {!! $errors->has('jenis_1') ? 'has-error' : '' !!}">
                <div class="form-group">
                    <label for="jenis_1">Jenis Identitas</label>
                    {!! Form::select('jenis_1', ['ktp' => 'ktp', 'sim' => 'sim', 'stnk' => 'stnk', 'instansi' => 'instansi'], 'ktp', ['class'=>'form-control']) !!}
                </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group  {!! $errors->has('jenis_2') ? 'has-error' : '' !!}">
                <div class="form-group">
                    ...
                    {!! Form::select('jenis_2', ['ktp' => 'ktp', 'sim' => 'sim', 'stnk' => 'stnk', 'instansi' => 'instansi'], 'ktp', ['class'=>'form-control']) !!}
                </div>
            ...
            <div class="form-group  {!! $errors->has('nomor_2') ? 'has-error' : '' !!}">
                <div class="form-group">
                    ...
                    {!! Form::text('nomor_2', null, ['class'=>'form-control', 'placeholder'=>'masukkan nomor']) !!}
                </div>
