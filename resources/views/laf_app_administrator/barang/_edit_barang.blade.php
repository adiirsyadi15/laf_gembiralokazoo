<div class="form-group  {!! $errors->has('nama_barang') ? 'has-error' : '' !!}">
  ...
  {!! Form::text('nama_barang', $barangs->nama, ['class'=>'form-control', 'placeholder'=>'masukkan nama barang']) !!}
  </div>
...
<input type="submit" name="simpan_barang"  class="submit btn btn-success" value="Simpan">
